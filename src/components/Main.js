...
//     try {
//       let updatedMovieFromAxios = await axios.post(
//         `${process.env.REACT_APP_SERVER}/ask`,
//         { prompt }
//       );
...
//         console.log('Saved movie:', response.data);
//       } catch (error) {
//         console.log(error.message);
//       }
//     }
...
//             <Card.Img
//               variant="top"
//               src={`https://image.tmdb.org/t/p/original${searchResult.imageURL}`}
//               alt="Movie Poster"
//             />
//             <Card.Body>
//               <Card.Title>{searchResult.title.toUpperCase()}</Card.Title>
//               <Button onClick={() => this.addToWatchlist(searchResult)}>
//                 Add to Watch List
//               </Button>
//             </Card.Body>
//           </Card>
...
//             </Accordion.Header>
//             <Accordion.Body>
//               {searchResult.representationDescription}
//             </Accordion.Body>
//           </Accordion.Item>
//           <Accordion.Item eventKey="6">
//             <Accordion.Header className="accordion-header">
